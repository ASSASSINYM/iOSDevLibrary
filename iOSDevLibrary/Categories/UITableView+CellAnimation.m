...
- (void)moveAnimation
{
    ...
    for (int i = 0; i < cells.count; i++) {
        ...
        cell.transform = CGAffineTransformMakeTranslation(-MT_SCREEN_WIDTH, 0);
...
- (void)fallAnimation
{
    ...
    for (int i = 0; i < cells.count; i++) {
        UITableViewCell *cell = [self.visibleCells objectAtIndex:i];
        cell.transform = CGAffineTransformMakeTranslation(0, - MT_SCREEN_HEIGHT);
...
- (void)springListAnimation
{
    ...
    for (int i = 0; i < cells.count; i++) {
        ...
        cell.layer.transform = CATransform3DMakeTranslation(0, -MT_SCREEN_HEIGHT, 20);
